        ...
        <div class="container">
            ...
            <nav class="text-center">
                <ul class="pagination">
                    <c:if test="${curPage>1}">
                        <li>
                            <a href="<%=request.getContextPath()%>/queryByConditions?curPage=${curPage-1}&uName=${name}&qq=${qq}">
                                <span>&laquo;</span>
                            </a>
                        </li>
                    </c:if>
                    ...
                    <c:forEach begin="${start}" end="${end}" step="1" var="i">
                        <c:if test="${curPage==i}">
                            <li class="active">
                                <a href="<%=request.getContextPath()%>/queryByConditions?curPage=${i}&uName=${name}&qq=${qq}">${i}</a>
                            </li>
                        </c:if>
                        <c:if test="${curPage!=i}">
                            <li>
