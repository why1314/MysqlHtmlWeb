...
public class OtOUtils {
    ...
    public static List queryByArgs(Class clazz, String sql, Object... args) throws Exception {
...
//        获取sql中？个数
    ...
    public static void main(String[] args) {
        ...
        try {
            List<User> list = queryByArgs(User.class, "select * from user where id in(?,?)", 1, 2);
